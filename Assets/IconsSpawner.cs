...
public class IconsSpawner : MonoBehaviour
{
    ...
    private void Start()
    {
        ...
        _spawnAreaMin = new Vector2(playerPos.x - 20, playerPos.y - 20);
        _spawnAreaMax = new Vector2(playerPos.x + 20, playerPos.y + 20);
        SpawnIcons();
    ...
    private void Update()
    {
        ...
        if (Mathf.Abs(deltaPosX) > 20 || Mathf.Abs(deltaPosY) > 20)
        {
